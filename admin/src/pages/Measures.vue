  ...
  <q-page class=" q-pa-md">
    <div class="gt-xs row flex">
      <q-breadcrumbs class="text-grey">
        ...
        <q-breadcrumbs-el label="Medidas" />
      </q-breadcrumbs>
    </div>
    <div class="row">
...
export default {
  ...
  methods: {
    getList (props) {
      ...
      this.loading = true
      this.$axios.post(ApiUrl + '/measures/list', toServer).then(res => {
    ...
    newItem () {
      this.act = 'post'
      this.titleForm = 'Añadir unidad de medida'
      this.item = { ...this.itemClear }
      this.showForm = true
    },
    editItem (itm) {
      this.act = 'update'
      this.titleForm = 'Editar unidad de medida'
      this.item = { ...itm }
      this.showForm = true
    },
    saveItem () {
